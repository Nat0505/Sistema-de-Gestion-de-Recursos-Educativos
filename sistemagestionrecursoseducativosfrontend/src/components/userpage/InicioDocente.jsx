...
/**
 * Componente que representa la página de inicio para los docentes
 *  
 */
function InicioDocente() {
    ...
    return (
        <div className='section-home'>
            ...
            <p>Bienvenido(a) docente, {profileInfo.nombre}</p>
            <br />
            <h3>Cursos</h3>
            <br />
            <hr />
            ...
            <div className="card">
                ...
                <div className="card-content">
                    ...
                    <br />
                    <p> Docente resposable:{profileInfo.nombre} {profileInfo.apellidos}</p>
                </div>
            </div>
            <div className="card">
                <img src="https://class.utp.edu.pe/static/media/courseP1.6604957d.png" alt="" />
